...
desc = "feasible  with 2 reflectors, different SAV ASNs, new attacker/victim"

feasible_001 = EngineTestConfig( #change name
    name="feasible_001", #change name
    desc=desc,
    scenario_config=SAVScenarioConfig(
        ...
        override_reflector_asns=frozenset({12,1}),
