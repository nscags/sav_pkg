...
desc = "ref alg a with 3 reflectors, different SAV ASNs, new attacker/victim"

ref_alg_a_003 = EngineTestConfig( #change name
    name="ref_alg_a_003", #change name
    desc=desc,
    scenario_config=SAVScenarioConfig(
        ...
        override_reflector_asns=frozenset({8,1,12}),
