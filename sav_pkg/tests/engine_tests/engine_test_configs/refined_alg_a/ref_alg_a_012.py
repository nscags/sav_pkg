...
desc = "ref alg a with 1 reflector as attacker, different SAV ASNs, new attacker/victim"

ref_alg_a_012 = EngineTestConfig( #change name
    name="ref_alg_a_012", #change name
    desc=desc,
