...
#
# desc = "alg a  with 3 reflectors one of them is the victim, different SAV ASNs, new attacker/victim"
#
# algo_a_006 = EngineTestConfig( #change name
#     name="algo_a_006", #change name
#     desc=desc,
...
#         override_reflector_asns=frozenset({2,1,8}),
