...
from sav_pkg.simulation_engine.policies.sav import EFP_A_wPeers

from sav_pkg.tests.engine_tests.engine_test_configs.as_graph_info import as_graph_info_000


desc = "Basic functionality test. EFP-A (w/ bilateral peer interfaces) deployed on multiple reflectors, " \
