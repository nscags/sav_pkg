...
desc = "ref alg a with 1 reflector as victim, different SAV ASNs, new attacker/victim"

ref_alg_a_007 = EngineTestConfig( #change name
    name="ref_alg_a_007", #change name
    desc=desc,
