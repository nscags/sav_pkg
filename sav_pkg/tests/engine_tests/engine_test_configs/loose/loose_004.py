...
desc = "Loose uRPF with 5 reflectors, different SAV ASNs, new attacker/victim"

loose_004 = EngineTestConfig( #change name
    name="loose_004", #change name
    desc=desc,
    scenario_config=SAVScenarioConfig(
        ...
        override_reflector_asns=frozenset({1,9,8,12,5}),
