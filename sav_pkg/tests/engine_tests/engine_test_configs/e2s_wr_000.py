...
desc = "Export-to-Some with Replacement"

e2s_wr_000 = EngineTestConfig(
    name="e2s_wr_000",
    desc=desc,
    scenario_config=SAVScenarioConfig(
        ...
        override_non_default_asn_cls_dict=frozendict(
            {
                6: BGPFullExport2Some_wReplacement,
                7: BGPFullExport2Some_wReplacement,
                3: BGPFullExport2Some_wReplacement,
            }
        ),
