...
desc = "ref alg a with 2 reflectors, different SAV ASNs, new attacker/victim"

ref_alg_a_001 = EngineTestConfig( #change name
    name="ref_alg_a_001", #change name
    desc=desc,
    scenario_config=SAVScenarioConfig(
        ...
        override_reflector_asns=frozenset({8,1}),
