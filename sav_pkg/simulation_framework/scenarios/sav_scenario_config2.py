...
class SAVScenarioConfig2(ScenarioConfig):
    # reflectors
    ...
    # source prefix used for data packets / victim announcement
    source_prefix: str = Prefixes.VICTIM.value

    # attacker announcement prefix
    attacker_prefix: str | None = None

    # issue ROA for specified source prefix
    source_prefix_roa: bool = False

    BaseSAVPolicyCls: BaseSAVPolicy | None = BaseSAVPolicy
    reflector_default_adopters: bool | None = False

    # set of asns adopting SAV, will adopt BaseSAVPolicyCls by default
    ...
    override_default_interface_dict: frozendict[str, frozenset] | None = None
