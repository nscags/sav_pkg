...
desc = "Loose uRPF with 9 reflectors, different SAV ASNs, new attacker/victim"

loose_013 = EngineTestConfig( #change name
    name="loose_013", #change name
    desc=desc,
    scenario_config=SAVScenarioConfig(
        ...
        override_reflector_asns=frozenset({1, 2, 3, 4,12,5, 8, 9, 10}),
