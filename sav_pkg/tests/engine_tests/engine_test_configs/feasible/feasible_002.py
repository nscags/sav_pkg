...
desc = "feasible  with 1 reflector, different SAV ASNs, new attacker/victim"

feasible_002 = EngineTestConfig( #change name
    name="feasible_002", #change name
    desc=desc,
    scenario_config=SAVScenarioConfig(
        ...
        override_reflector_asns=frozenset({10}),
