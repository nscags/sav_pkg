...
from sav_pkg.simulation_framework.scenarios import SAVScenarioConfig, SAVScenarioMinFP
...
def main():
    ...
    sim = Simulation(
        ...
        scenario_configs=(
            SAVScenarioConfig(
                ScenarioCls=SAVScenarioMinFP,
                BasePolicyCls=BGPFull,
                BaseSAVPolicyCls=BAR_SAV_PI_PP_Alg_B,
        ...
        output_dir=Path(f"~/sav/results/5r_500t_e2a_bspi_pp_alg_b_asra_min_fp").expanduser(),
        num_trials=500,
        parse_cpus=40,
