...
An extension to the widely-used BGP security simulator [BGPy](https://github.com/jfuruness/bgpy_pkg) to evaluate Source Address Validation (SAV) policies. This is the main branch which uses BGPy version 8.1.1. This version produced the results used in our paper and thus is maintained for legacy purposes. The latest version of the sav_pkg (which also uses the most recent release of BGPy) can be found in the 'lastest' branch. 
