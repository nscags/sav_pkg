...
desc = "Config test - attacker_broadcast=False: " \
       "Attacker should only send one packet for each reflector (i.e. Spoofing Host attack model)"

framework_000 = EngineTestConfig(
    name="framework_000",
    desc=desc,
