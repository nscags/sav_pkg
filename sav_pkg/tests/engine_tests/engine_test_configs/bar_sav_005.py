...
from sav_pkg.simulation_engine import BAR_SAV, BGPFullExport2Some_wReplacement
...
bar_sav_005 = EngineTestConfig(
    ...
    scenario_config=SAVScenarioConfig(
        ...
        override_non_default_asn_cls_dict=frozendict({4:BGPFullExport2Some_wReplacement}),
